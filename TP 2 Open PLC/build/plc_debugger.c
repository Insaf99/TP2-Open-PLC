 ...
 * Declare programs 
 **/
extern PLC_PRG RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.SENSOR_X), BOOL_P_ENUM},
{&(RES0__INSTANCE0.SENSOR_Y), BOOL_P_ENUM},
{&(RES0__INSTANCE0.LED_AMARILLO), BOOL_O_ENUM},
{&(RES0__INSTANCE0.LED_ROJO), BOOL_O_ENUM},
